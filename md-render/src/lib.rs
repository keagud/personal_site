...
static CSS: &str = include_str!(asset!("css/style.css"));
static QUOTES: &str = include_str!(asset!("quotes.json"));
static BASE_TEMPLATE: &str = include_str!(asset!("templates/base.html"));
